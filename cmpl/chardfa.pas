...
type
    ...
    TDFAComp_AnyChar = class(TDFAComparator)
        public
            constructor Create();
            destructor Destroy(); Override;
...
constructor TDFAComp_AnyChar.Create();
begin
    inherited Create();
end;

destructor TDFAComp_AnyChar.Destroy();
begin
    inherited Destroy();
end;

procedure TDFAComp_AnyChar.Free();
begin
end;

function TDFAComp_AnyChar.Compare(AInput : AnsiString) : Boolean;
begin
    Result := True;
end;
