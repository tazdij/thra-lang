...
type
  ...
  TParseGen = class(TObject)
    private
      FLabels : Array of TLabel;
      FLabelDefers : Array of TLabelDefer;
    ...
    public
      ...
      procedure Run(ATokens : TLexTokenArray);
...
begin
  ...
  if ADfaTokens[1].TokenId = Integer(ELexLabel) then
  begin
